...
const Hero = () => {
  return (
    <div className='w-full h-screen relative'>
        ...
        <div className='absolute top-0 w-full h-full flex flex-col justify-center text-center text-white p4'>
            <h1>Voyage First Classe</h1>
            <h3 className='py-4'>N°1 de la location de vacances</h3>
